...
const zh = {
  ...
  hero: {
    ...
    card: {
      ...
      specs: [
        { label: '容量范围', value: '10,000 ~ 50,000 mAh', icon: '⚡' },
        { label: '安全等级', value: 'IEC 62133 / UN38.3', icon: '🛡️' },
  ...
  about: {
    ...
    stats: [
      { value: '8年+', label: '深耕锂电行业', desc: '专注移动储能领域' },
      { value: '50+', label: '核心专利技术', desc: '半固态电芯自主研发' },
      { value: '500+', label: '全球B2B客户', desc: '覆盖30+国家和地区' },
      { value: '500万+', label: '年产能（件）', desc: '支持大批量快速交付' },
    ],
    milestones: [
      { year: '2016', event: '公司成立，专注锂电池研发' },
      { year: '2019', event: '获得首批半固态电芯专利技术' },
      { year: '2021', event: '通过 ISO 9001 质量体系认证' },
      { year: '2023', event: '半固态移动电源量产，出口 30+ 国' },
      { year: '2025', event: '年产能突破 500 万件，B2B 合作伙伴 500+' },
    ],
    timelineTitle: '发展历程',
  },
  ...
  products: {
    tag: 'Product Center',
    title: '产品中心',
    desc: '四大系列覆盖从商务到户外全场景需求，均支持 OEM/ODM 定制，满足不同目标市场的差异化竞争需求。',
    specTitle: '技术规格',
    btnQuote: '立即询价',
    btnSample: '申请样品',
    specLabels: {
  ...
  contact: {
    ...
    info: [
      ...
      { label: '工厂地址', value: '深圳市宝安区石岩街道塘头社区塘头1号路8号创维创新谷2#楼B0906-B0911号 ', sub: '欢迎预约参观工厂' },
    ],
    promise: {
      title: '我们承诺',
    ...
    form: {
      ...
      product: '感兴趣的产品',
      productPh: '请选择产品系列',
      productOptions: ['请选择产品系列', 'PowerCore Ultra S1（旗舰款）', 'PowerCore Pro P2（商务款）', 'PowerCore Rugged R3（户外款）', 'PowerCore Mini M4（便携款）', 'OEM/ODM 定制款'],
      quantity: '预计采购量',
      quantityPh: '请选择数量范围',
...
const en: Translations = {
  ...
  hero: {
    ...
    stats: [
      ...
      { value: '8 Yrs', label: 'Industry Expertise' },
    ...
    card: {
      ...
      subtitle: 'Semi-Solid State Power Bank Series',
      specs: [
        { label: 'Capacity', value: '10,000 ~ 50,000 mAh', icon: '⚡' },
        { label: 'Safety', value: 'IEC 62133 / UN38.3', icon: '🛡️' },
  ...
  about: {
    ...
    stats: [
      { value: '8+ Yrs', label: 'Li-Battery Expertise', desc: 'Focused on mobile energy storage' },
      { value: '50+', label: 'Core Patents', desc: 'Self-developed semi-solid cells' },
      { value: '500+', label: 'Global B2B Clients', desc: 'Covering 30+ countries' },
      { value: '5M+', label: 'Annual Capacity (pcs)', desc: 'Large-scale fast delivery' },
    ],
    milestones: [
      { year: '2016', event: 'Company founded, focused on Li-battery R&D' },
      { year: '2019', event: 'Obtained first batch of semi-solid cell patents' },
      { year: '2021', event: 'Passed ISO 9001 quality management certification' },
      { year: '2023', event: 'Mass production of semi-solid power banks, exported to 30+ countries' },
      { year: '2025', event: 'Annual capacity exceeded 5 million units, 500+ B2B partners' },
    ],
  ...
  products: {
    ...
    desc: 'Four series covering all scenarios from business to outdoor, all supporting OEM/ODM customization to meet differentiated market needs.',
  ...
  contact: {
    ...
    info: [
      ...
      { label: 'Factory Address', value: 'RM 906-912 South Area Block B Building 2, Skyworth Innovation Valley, Songbai Road, Shiyan st., Baoan District Shenzhen Guangdong China 518108', sub: 'Factory tours available by appointment' },
    ],
    promise: {
      title: 'Our Promise',
    ...
    form: {
      ...
      productOptions: ['Select a product series', 'PowerCore Ultra S1 (Flagship)', 'PowerCore Pro P2 (Business)', 'PowerCore Rugged R3 (Outdoor)', 'PowerCore Mini M4 (Compact)', 'OEM/ODM Custom'],
...
const ja: Translations = {
  ...
  hero: {
    ...
    card: {
      ...
      subtitle: 'Semi-Solid State Power Bank Series',
      specs: [
        { label: '容量範囲', value: '10,000 ~ 50,000 mAh', icon: '⚡' },
        { label: '安全規格', value: 'IEC 62133 / UN38.3', icon: '🛡️' },
  ...
  about: {
    ...
    stats: [
      { value: '8年+', label: 'リチウム電池業界経験', desc: 'モバイル蓄電分野に特化' },
      { value: '50+', label: 'コア特許技術', desc: '半固体セルを自社開発' },
      { value: '500+', label: 'グローバルB2B顧客', desc: '30カ国以上に展開' },
      { value: '500万+', label: '年間生産能力（個）', desc: '大量注文に迅速対応' },
    ],
    milestones: [
      { year: '2016', event: '会社設立、リチウム電池研究開発に注力' },
      { year: '2019', event: '初の半固体セル特許を取得' },
      { year: '2021', event: 'ISO 9001品質マネジメント認証取得' },
      { year: '2023', event: '半固体モバイルバッテリー量産開始、30カ国以上に輸出' },
      { year: '2025', event: '年間生産能力500万個突破、B2Bパートナー500社以上' },
    ],
    timelineTitle: '沿革',
  },
  ...
  products: {
    tag: 'Product Center',
    title: '製品紹介',
    desc: 'ビジネスからアウトドアまで全シーンをカバーする4つのシリーズ。すべてOEM/ODMカスタマイズに対応し、異なる市場での差別化ニーズにお応えします。',
    specTitle: '仕様',
    btnQuote: '見積依頼',
    btnSample: 'サンプル申請',
    specLabels: {
  ...
  contact: {
    ...
    info: [
      ...
      { label: '工場住所', value: '中国広東省深セン市宝安区石岩街道松白路创维イノベーションバレー 2 号棟 B 区南エリア RM906-912', sub: '工場見学は事前予約制' },
    ],
    promise: {
      title: 'お約束',
    ...
    form: {
      ...
      product: 'ご関心のある製品',
      productPh: '製品シリーズを選択',
      productOptions: ['製品シリーズを選択', 'PowerCore Ultra S1（フラッグシップ）', 'PowerCore Pro P2（ビジネス）', 'PowerCore Rugged R3（アウトドア）', 'PowerCore Mini M4（コンパクト）', 'OEM/ODMカスタム'],
      quantity: '希望数量',
      quantityPh: '数量範囲を選択',
